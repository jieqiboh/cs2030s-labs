...
class Lab5 {
  ...
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> actuallyDb = new Constant<>() {
      @Override
    ...
    Constant<String> noSuchEntry = new Constant<>() {
      @Override
      public String init() {
    ...
    Immutator<Actually<Map<String, Map<String, String>>>,Map<String, Map<String, Map<String, String>>>> mod = new Immutator<>() {
      public Actually<Map<String, Map<String, String>>> invoke(Map<String, Map<String, Map<String, String>>> m) {
        return Actually.ok(m.get(module));
      }
    };

    Immutator<Actually<Map<String, String>>,Map<String, Map<String, String>>> stu = new Immutator<>() {
      public Actually<Map<String, String>> invoke(Map<String, Map<String, String>> m) {
        return Actually.ok(m.get(student));
      }
    };

    Immutator<Actually<String>,Map<String, String>> as = new Immutator<>() {
      public Actually<String> invoke(Map<String, String> m) {
        return Actually.ok(m.get(assessment).toString());
      }
    };

    return actuallyDb.init().next(mod).next(stu).next(as).except(noSuchEntry);
